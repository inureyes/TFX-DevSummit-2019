...
class ExamplesGen(BaseComponent):
  ...
  def _create_output_dict(cls):
    return {
        'output':
            tfx.tfx_types.TfExampleSource(
                default_file_name='data.tfrecord',
                artifact_name='output',
                splits=tfx.tfx_types.DEFAULT_EXAMPLE_SPLITS),
    }
  ...
  def _create_output_dict(cls):
    ...
    return {
        'transform_output':
            tfx.tfx_types.TfxType(
                'TransformPath',
                default_file_name='transform_output',
                artifact_name='transform_output'),
        'transformed_examples':
            tfx.tfx_types.TfxType(
                'ExamplesPath',
                default_file_name='tfx.transformed',
                artifact_name='transformed_examples',
                splits=tfx.tfx_types.DEFAULT_EXAMPLE_SPLITS)
    }
...
class Evaluator(BaseComponent):
  ...
  def _create_output_dict(cls):
    return {
        'output':
            tfx.tfx_types.TfxType(
                'ModelEvalPath', default_file_name='', artifact_name='output')
    }
...
class Trainer(BaseComponent):
  ...
  def _create_output_dict(cls):
    return {
        'output':
            tfx.tfx_types.TfxType(
                'ModelExportPath', default_file_name='', artifact_name='output')
    }
