...
from tfx.utils.types import ARTIFACT_STATE_MISSING
...
class BaseDriver(object):
  """BaseDriver provides a default implementation of Component driver."""
  ...
  def _default_caching_handling(self, input_dict, output_dict, exec_properties,
    ...
    for output_name, output_list in output_dict.items():
      for output_artifact in output_list:
        # Updates outputs uri based on execution id and split.
